...
// private val mongoTemplate: MongoTemplate) : JobOfferStatisticService

@Service
class JobOfferStatisticServiceImpl(private val jobOfferSkillsRepository: JobOfferSkillsRepository) : JobOfferStatisticService{
